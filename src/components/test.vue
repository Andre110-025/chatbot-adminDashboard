          ...
          >
            ...
            >
              ...
              <div
                ...
                class="absolute shadow-2xl overflow-hidden flex flex-col transition-all max-w-[90vw] max-h-[60vh]"
                :style="{
                  ...
                  bottom: customization.bubblesize + 16 + 'px',
                  right: customization.position.includes('right') ? '0' : 'auto',
                  left: customization.position.includes('left') ? '0' : 'auto',
                }"
              >
                <div
                  class="p-4"
